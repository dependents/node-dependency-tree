...
export default class Config {
  ...
  constructor(options = {}) {
    ...
    if (this.filter && typeof this.filter !== 'function') throw new TypeError('filter must be a function');
    if (this.requireConfig !== undefined && typeof this.requireConfig !== 'string') throw new TypeError('requireConfig must be a file path string');
    if (this.webpackConfig !== undefined && typeof this.webpackConfig !== 'string') throw new TypeError('webpackConfig must be a file path string');
    if (this.tsConfigPath !== undefined && typeof this.tsConfigPath !== 'string') throw new TypeError('tsConfigPath must be a string');
    if (this.nonExistent !== undefined && !Array.isArray(this.nonExistent)) throw new TypeError('nonExistent must be an array');
